...
{
    public class TieAutomationForDirectorGeneral
    {
        ...
        public TieAutomationForDirectorGeneral(ChromeDriver driver)
        {
            this.driver = driver;
        }
        ...
        public void AfterExecutionComplete()
        {
            PlaySound();
        ...
        protected virtual bool SelectOffice()
        {
            //Select office
        ...
        private bool GoNextAfterOffceSelection()
        {
        ...
        protected virtual bool EnterNIEAndName()
        {
        ...
        protected bool ClickAndWaitForPageToLoad(IWebElement element, int timeout = 10)
        {
            try
            {
